...
class UserCreationFormWithEmail(UserCreationForm):
	...
	first_name = forms.CharField(required=True, help_text="Requerido, 254 caracteres como maximo y debe ser valido")
	last_name = forms.CharField(required=True, help_text="Requerido, 254 caracteres como maximo y debe ser valido")
